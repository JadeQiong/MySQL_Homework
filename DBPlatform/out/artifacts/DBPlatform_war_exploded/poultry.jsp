...
<body background="img/poultry.jpeg"
...
<h1 class = "text_big">家禽类</h1>

<div class = "div1">
    <div class = "text_middle">欢迎来到家禽类选购!</div><br>
...
<%
    ...
    GoodList = goodService.queryGoodsByKind("poultry");
    System.out.println("Query for poultry");
...
<div class = "box">
    ...
    <div class = "buttomBox">
        <form action="poultry.jsp" method="post">
            <tr>
