...
<body background="img/aquatic.jpeg"
...
<h1 class = "text_big">水产类</h1>

<div class = "div1">
    <div class = "text_middle">欢迎来到水产类选购!</div><br>
...
<%
    ...
    GoodList = goodService.queryGoodsByKind("aquatic");
    System.out.println("Query for aquatic");
...
<div class = "box">
    ...
    <div class = "buttomBox">
        <form action="aquatic.jsp" method="post">
            <tr>
