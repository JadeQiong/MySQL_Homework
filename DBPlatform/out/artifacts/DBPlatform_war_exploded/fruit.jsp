...
<body background="img/fruit.jpeg"
...
<h1 class = "text_big">水果类</h1>

<div class = "div1">
    <div class = "text_middle">欢迎来到水果类选购!</div><br>
...
<%
    ...
    GoodList = goodService.queryGoodsByKind("fruit");
    System.out.println("Query for fruit");
